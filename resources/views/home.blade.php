...
<head>
    ...
    <meta name="author" content="Hüseyin Çetinkoz @SiyahKare">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Gelişen  <strong>Dijital</strong> Dünyada Yerinizi Alın.</h1>
                ...
                <div class="col-md-3 mb-3">
                    <a href="#" class="featured-img">
                        <div class="text-1 p-4 d-flex align-items-center">
                            <h3>Mobil Uygulama Geliştirme<br><span class="tag">Website</span></h3>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row no-gutters d-flex align-items-end">
                                ...
                                <div class="col-md-8">
                                    <a href="#" class="featured-img">
                                        <div class="text-1 p-4 d-flex align-items-center">
                                            <h3>Web Tasarım Hizmeti<br><span class="tag">Website</span></h3>
                                        </div>
                                        <img src="images/designweb.png" class="img-fluid" alt="">
                                        <div class="text p-4 d-flex align-items-center">
                                ...
                                <div class="col-md-4">
                                    <a href="#" class="featured-img">
                                        <div class="text-1 p-4 d-flex align-items-center">
                                            <h3>Sosyal Medya Yönetimi<br><span class="tag">Website</span></h3>
                                        </div>
                                        <img src="images/sosyalmedya.png" class="img-fluid" alt="">
                                        <div class="text p-4 d-flex align-items-center">
                        ...
                        <div class="col-md-12">
                            <div class="row no-gutters d-flex align-items-start">
                                <div class="col-md-8">
                                    <a href="#" class="featured-img">
                                        <div class="text-1 p-4 d-flex align-items-center">
                                            <h3>Video Prodüksiyon<br><span class="tag">Website</span></h3>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <a href="#" class="featured-img">
                                        <div class="text-1 p-4 d-flex align-items-center">
                                            <h3>Drone Çekimi<br><span class="tag">Website</span></h3>
                                        </div>
            ...
            <div class="row mt-5 d-flex justify-content-center">
                <div class="col-md-8 text-center heading-section ftco-animate">
                    ...
                    <div class="card-header card-header-image">
                                ...
                                <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/500399158?title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
                            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 d-flex justify-content-center counter-wrap ftco-animate">
                <div class="block-18 text-center">
                    <div class="text">
                        <strong class="number" data-number="895000">0</strong>
                        <span>Satır Kod</span>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 d-flex justify-content-center counter-wrap ftco-animate">
                <div class="block-18 text-center">
                    <div class="text">
                        <strong class="number" data-number="260">0</strong>
                        <span>Proje</span>
                    </div>
                </div>
            </div>
    ...
    <div class="parallax-img d-flex align-items-center">
        <div class="container">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
                    <h2>Abone Olun</h2>
                    <p>Abone Olarak, Kampanyalar ve indirimlerden ilk siz bilgi sahibi olabilirsiniz..</p>
