    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="about" class="nav-link">Hakkımızda</a></li>
...
<div class="hero-wrap js-fullheight">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="home">Anasayfa</a></span> <span>Hakkımızda</span></p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
                <a href="portfolio" class="image image-2 order-2" style="background-image: url('images/qquality.svg');" data-scrollax=" properties: { translateY: '-20%'}"></a>
